...
public class GetApplicationPermissionsRequestHandler(
    ILogger<GetApplicationPermissionsRequestHandler> logger,
    IOpenIddictApplicationManager applicationManager)
    : IRequestHandler<GetApplicationPermissionsRequest, ApiResult<List<string>?>>
{
