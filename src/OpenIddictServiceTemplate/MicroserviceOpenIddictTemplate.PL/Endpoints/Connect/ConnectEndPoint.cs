...
using Serilog;
using ConnectHandler = MicroserviceOpenIddictTemplate.PL.Endpoints.Connect.Helper.ConnectHandler;

namespace MicroserviceOpenIddictTemplate.PL.Endpoints.Connect;
